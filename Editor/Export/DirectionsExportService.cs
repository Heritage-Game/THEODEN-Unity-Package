    ...
    public static class DirectionsExportService
    {
            ...
            out string error)
        {
            ...
            directionsFolderPath =
                NormalizeUnityPath(directionsFolderPath);
             ...
             * AddressableAssetJsonConverter reads the assigned addresses.
             */
            if (!DirectionsAddressablesSetupService
                    .SetupAddressablesForDirections(
                        directionsData,
                        projectId,
                        poiId,
                        mediaFolderPath,
        ...
        /// <summary>
        /// Temporary compatibility overload for the old Directions window.
        /// Remove it after DirectionsToPOICreatorWindow has been migrated.
        /// </summary>
        [Obsolete(
            "Use ExportDirections with projectId."
        )]
        public static bool ExportDirections(
            DirectionsToPOIData directionsData,
            string poiId,
        ...
        {
            error =
                "DirectionsToPOICreatorWindow still uses the legacy " +
                "Directions export method. Update the window before exporting.";
            ...
            out string error)
        {
            ...
            {
                error =
                    "Could not find GUID for exported Directions JSON: " +
                    jsonAssetPath;
